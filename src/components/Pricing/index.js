          ...
          <div className="section-header center-content">
            <div className="container-xs">
              <h2 className="mt-0 mb-16">
                Affordable and Friendly Pricing
              </h2>
              <p className="m-0">
                    ...
                    <div className="
                      ...
                      <span className="
                                              ...
                                              ">$</span><span className="
                                                  ...
                                                  h1
                                                  pricing-switchable
                                              " data-pricing-monthly={34} data-pricing-yearly={27}>25</span>
                    </div>
                    <div className="
                    ...
                    <div className="
                      ...
                      <span className="
                                              ...
                                              ">$</span><span className="
                                                  ...
                                                  h1
                                                  pricing-switchable
                                              " data-pricing-monthly={54} data-pricing-yearly={47}>75</span>
                    </div>
                    <div className="
                                              text-xs text-color-low
                                          ">
                    ...
                    <div className="
                      ...
                      <span className="
                                              ...
                                              ">$</span><span className="
                                                  ...
                                                  h1
                                                  pricing-switchable
                                              " data-pricing-monthly={74} data-pricing-yearly={67}>100</span>
                    </div>
                    <div className="
                                              text-xs text-color-low
                                          ">
